...
router.get("/products/new",isSeller,async(req,res)=>{
 ...
 router.post("/products", isSeller,async(req,res)=>{
 ...
 // get the edit form
 router.get("/products/:productid/edit" ,isSeller, async(req, res)=>{
 ...
 //update a product
 router.patch("/products/:productid" ,isSeller, async(req,res)=>{
 ...
 // delete a product
 router.delete("/products/:productid", isSeller,async(req,res)=>{
